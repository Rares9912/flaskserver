    ...
    def helper_test_endpoint(self, endpoint):
        ...
        for input_file in input_files:
            ...
            with self.subTest():
                ...
                res = requests.post(f"http://127.0.0.1:8000/api/{endpoint}", json=req_data)
                # print(f'this is the endpoint: {req_data}')
                ...
                self.check_res_timeout(
                    res_callable = lambda: requests.get(f"http://127.0.0.1:8000/api/get_results/{job_id}"),
